...
const OurServices = () => {
  return (
    <div>
      <h1 className="font-mh-exo-2">Our Services</h1>
      <div className="our-services ">
        <div class="card-container ">
          <div class="card ">
            <div class="front-content ">
              <div className="col">
                {/* Add svg image top of the card */}
                <svg
                  version="1.1"
                  id="_x32_"
		...
		c0,4.406-3.586,8-8,8H48c-4.414,0-8-3.594-8-8V104h432V464z"
                    />
                    <rect x="96" y="192" class="st0" width="50" height="50" />
                    <rect x="96" y="352" class="st0" width="50" height="32" />
                    <rect
                      x="304"
                      y="192"
                      class="st0"
            ...
            <div class="content">
              ...
              <p className="font-p-exo-2">
                ...
                websites that align with the unique identities of our clients.
                We focus on creating user-friendly and responsive platforms that
        ...
        <div class="card-container">
          <div class="card">
            ...
            <div class="content">
              ...
              <p className="font-p-exo-2">
                Understanding the importance of visibility in the digital
                landscape, we implement robust Search Engine Optimization (SEO)
                strategies. This ensures that our clients' websites rank higher
                in search engine results, driving increased traffic and
        ...
        <div class="card-container ">
          <div class="card">
            ...
            <div class="content">
              ...
              <p className="font-p-exo-2">
                As part of our services, we facilitate the establishment of
                professional and personalised email domains for our clients.
                This not only enhances their brand image but also contributes to
        ...
        <div class="card-container">
          <div class="card">
            ...
            <div class="content">
              ...
              <p className="font-p-exo-2">
                Recognizing the dynamic nature of the online environment, we
                provide ongoing maintenance services to keep websites running
                smoothly. Our commitment to security ensures that client
                websites are protected against potential threats, guaranteeing a
                secure online experience for both businesses and their
                customers.
              </p>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="content">
              ...
              <p className="font-p-exo-2-final">
                We go beyond just building websites by offering comprehensive
                branding solutions. Our team is skilled in creating distinctive
                logos and establishing cohesive brand identities that resonate
                with the target audience, fostering brand recognition and
                loyalty.
              </p>
            </div>
          </div>
