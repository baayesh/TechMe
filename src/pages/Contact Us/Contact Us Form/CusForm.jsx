      ...
      <div>
        ...
        <div className="contact-us-mdiv">
          <div className="contact-us-details">
            <div className="contact-us-details-row1">
              <div className="contact-us-details-row1-col1">
              ...
              <div className="contact-us-details-row1-col2">
                <div className="conde-card">
                  <div className="cc-circle">
                    {/*  svg mobile */}
                    <svg
            ...
            <div className="contact-us-details-row2">
              <div className="contact-us-details-row2-col1">
                <div className="conde-card">
                  <div className="cc-circle">
                    <svg
                      width="50px"
              ...
              <div className="contact-us-details-row2-col2">
                <div className="map-main">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2892.4592464588695!2d172.64624227718866!3d-43.53446798211555!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6d3189e6915c9db3%3A0xe926f715ce61caa7!2sTechMe%20Limited!5e0!3m2!1sen!2slk!4v1714058842062!5m2!1sen!2slk"
                    style={{ border: 0 }}
                    allowfullscreen=""
                    loading="lazy"
                    className="map-map"
          ...
          <div className="contact-us-form">
            <form ref={form} onSubmit={handleSubmit}>
              <div className="">
                ...
                <ReCAPTCHA className="cus-recaptcha" sitekey="6LfT59IpAAAAAAshV4B1vkX1WCguaruO7Cb2Xw8r" onChange={onChange} />
                
                <button type="submit" disabled={!verified} class=" custom-button-2">
                  SEND
                </button>
              </div>
            </form>
